...
public static class DbModelCreator
{
    public static void CreateModels(ModelBuilder modelBuilder) {
		...
		Role managerRole = new Role{
		    Id = 2, Name = RoleName.Manager
		};
		
		modelBuilder.Entity<Role>().HasData(managerRole);
		modelBuilder.Entity<Customer>().HasData(
		    new Customer{Id = 1, RoleId = customerRole.Id, Username = "rhys", Password = "d74ff0ee8da3b9806b18c877dbf29bbde50b5bd8e4dad7a3a725000feb82e8f1", PassportNo = "241221421241", PhoneNo = "634644638643"}
		);
		...
		Operator Hilton = new Operator{ Id = 1, Name = "Hilton" };
		...
		Hotel HiltonLondonHotel = new Hotel{Id = 1, Name = "Hilton London Hotel", Description = "a hotel", OperatorId = Hilton.Id};
		...
		modelBuilder.Entity<Room>().HasData(
			...
			new Room{Id = 1, Name = "Single Bed", HotelId = HiltonLondonHotel.Id, Price = 37500, Spaces = 20, PackageDiscount = 10},
			new Room{Id = 2, Name = "Double Bed", HotelId = HiltonLondonHotel.Id, Price = 77500, Spaces = 20, PackageDiscount = 20},
			new Room{Id = 3, Name = "Family Suite", HotelId = HiltonLondonHotel.Id, Price = 95000, Spaces = 20, PackageDiscount = 40},
			...
			new Room{Id = 13, Name = "Single Bed", HotelId = NevisBankInnFortWilliam.Id, Price = 9000, Spaces = 20, PackageDiscount = 10},
			new Room{Id = 14, Name = "Double Bed", HotelId = NevisBankInnFortWilliam.Id, Price = 10000, Spaces = 20, PackageDiscount = 20},
			new Room{Id = 15, Name = "Family Suite", HotelId = NevisBankInnFortWilliam.Id, Price = 15500, Spaces = 20, PackageDiscount = 40},
